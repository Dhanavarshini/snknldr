...
int loadx() {
  ...
  printf(
      "                                   Please wait the game is loading up!");
  Beep(500, 100);
  Sleep(500);
  printf(".");
...
labelg:
  ...
  printf(ANSI_COLOR_GREEN
         "                                   "
         "--------------------------------------------\n" ANSI_COLOR_RESET);
  printf(ANSI_COLOR_GREEN "                                   |      2      |  "
                          "    INFO                  |\n" ANSI_COLOR_RESET);
  printf(ANSI_COLOR_GREEN
         "                                   "
         "--------------------------------------------\n\n" ANSI_COLOR_RESET);
label1:
  printf(ANSI_COLOR_GREEN "                                        Please "
                          "enter your input.....: " ANSI_COLOR_RESET);
  ...
  labeltry:
    clrscr();
    printf("\n\n\n");
    printf("                                    Here's a Snakes and ladders "
           "board game to play with your friends and family.\n\n\n\n\n\n\n");
    printf("You need to print the board game, and you can print counters and "
           "dice for the game too.\n\n");
    printf("How to play:");
    printf("Each player puts their counter on the space that says 'start "
           "here'.\n\n");
    printf("Take it in turns to roll the dice. Move your counter forward the "
           "number of spaces shown on the dice.\n\n");
    printf("If your counter lands at the bottom of a ladder, you can move up "
           "to the top of the ladder.\n\n");
    printf("If your counter lands on the head of a snake, you must slide down "
           "to the bottom of the snake.\n\n");
    printf("The first player to get to the space that says '100' is the "
           "winner.\n\n\n\n");
    printf("Have fun \n");
    ...
    printf("\n\n\n\n");
    MessageBeep(MB_OK);
    printf(ANSI_COLOR_RED "                                     please enter "
                          "the correct input\n");
    printf("                                seems you have entered invalid "
           "value" ANSI_COLOR_RESET);
    Sleep(1000);
    goto labelg;
  }
...
label3:
  clrscr();
  printf(ANSI_COLOR_BLUE
         "Enter the number of players with in 5 : " ANSI_COLOR_RESET);
  scanf("%d", &n);
  ...
  labelb:
    clrscr();
    printf(ANSI_COLOR_RED "Oops Looks like you are alone and you cant play "
                          "Multiplayer game alone\n " ANSI_COLOR_RESET);
    printf(ANSI_COLOR_GREEN "you are being redirected to the single player "
                            "environment\n " ANSI_COLOR_RESET);
...

{
  ...
  if (P != 1) {
    ...
    printf(
        "Congratulations player you made it out you have won over computer\n");
  }
  MessageBeep(MB_OK);
}
...
int main() {
  ...
  int dice; /*IN for checking key is pressed or not~~ dice is to take dice
               count*/
  ...
  P = playerType();
  {
    if (P == 1) {
      ...
      Sleep(500);
      MessageBeep(MB_OK);
      printf("Player 1 is computer and player 2 is the user");
      Sleep(3000);
      P = 2;
    }
  }
    ...
    if (Position != 100) {
      for (i = 0; i < P; i++) {
...

        {
          MessageBeep(MB_OK);
          printf(ANSI_COLOR_YELLOW
                 "Great!, you got lucky its on ladder .\n You are being "
                 "redirected to:%d " ANSI_COLOR_RESET,
                 Nplace);
          Sleep(1000);
        }
        ...
        if (position[i] > Nplace) {
          ...
          printf(ANSI_COLOR_RED "Oops.., you have landed on a snake.\n you are "
                                "being redirected to:%d" ANSI_COLOR_RESET,
                 Nplace);
          Sleep(1000);
        }
